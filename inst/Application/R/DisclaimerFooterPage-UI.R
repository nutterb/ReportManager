...
UI_TAB_DISCLAIMER_FOOTER <- 
  tabsetPanel(
    ...
    tabPanel(
      title = "Disclaimers", 
      actionButton(inputId = "btn_disclaimer_add", 
                   label = "Add", 
                   style = "float:right"), 
      actionButton(inputId = "btn_disclaimer_edit", 
                   label = "Edit", 
                   style = "float:right"), 
      actionButton(inputId = "btn_disclaimer_deactivate", 
                   label = "Deactivate", 
                   style = "float:right"), 
      actionButton(inputId = "btn_disclaimer_activate", 
                   label = "Activate", 
                   style = "float:right"), 
    ...
    tabPanel(
      title = "Footers", 
      actionButton(inputId = "btn_footer_add", 
                   label = "Add", 
                   style = "float:right"), 
      actionButton(inputId = "btn_footer_edit", 
                   label = "Edit", 
                   style = "float:right"), 
      actionButton(inputId = "btn_footer_deactivate", 
                   label = "Deactivate", 
                   style = "float:right"), 
      actionButton(inputId = "btn_footer_activate", 
                   label = "Activate", 
                   style = "float:right"), 
